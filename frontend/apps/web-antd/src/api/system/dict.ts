...
export async function getSystemDictList(params: SystemDictApi.ListParams) {
    return requestClient.get<SystemDictApi.ListResult>('/data-dictionary', { params });
}
...
export async function updateSystemDict(id: number, data: Partial<SystemDictApi.Dict>) {
