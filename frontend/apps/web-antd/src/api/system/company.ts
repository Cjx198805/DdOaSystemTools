...
export async function getSystemCompanyList(params: SystemCompanyApi.ListParams) {
    return requestClient.get<SystemCompanyApi.ListResult>('/company', { params });
}

export async function createSystemCompany(data: Partial<SystemCompanyApi.Company>) {
    return requestClient.post('/company', data);
}

export async function updateSystemCompany(id: number, data: Partial<SystemCompanyApi.Company>) {
