...
export async function getFieldPermissionList(
  params: SystemFieldPermissionApi.ListParams,
) {
  return requestClient.get<SystemFieldPermissionApi.ListResult>(
    '/field-permission',
    { params },
  );
}
...
export async function createFieldPermission(
  data: Partial<SystemFieldPermissionApi.FieldPermission>,
) {
